...
if (empty($configured_slides)) {
	$configured_slides = [
		[
			'url' => '//flexslider.woothemes.com/images/kitchen_adventurer_donut.jpg',
			'text' => '<strong>Lorem ipsum dolor</strong><br>Consectetuer adipiscing elit. Donec eu massa vitae arcu laoreet aliquet.',
			'link' => false,
		], [
			'url' => '//flexslider.woothemes.com/images/kitchen_adventurer_caramel.jpg',
			'text' => '<strong>Praesent</strong><br>Maecenas est erat, aliquam a, ornare eu, pretium nec, pede.',
			'link' => false,
		], [
			'url' => '//flexslider.woothemes.com/images/kitchen_adventurer_cheesecake_brownie.jpg',
			...
			'url' => '//flexslider.woothemes.com/images/kitchen_adventurer_lemon.jpg',
